...
file= "Data2_V2_nettoye_nettoye.xlsx"

df= pd.read_excel(file)
colonne_categorie=["year","actor_type","industry","event_type","event_subtype","country","actor_country"]
...
plt.scatter(individus[0], individus[1], label="Individus", alpha=0.6, c='blue')
